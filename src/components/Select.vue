<script setup lang="ts">
	...
	const	selected = ref<[any|undefined, number|undefined]>([props.modelValue != undefined ? props.data[props.modelValue] : undefined, props.modelValue])
	...
	watch(() => props.modelValue, (new_value) => {
		...
		selected.value = [new_value != undefined ? props.data[new_value] : undefined, new_value]
